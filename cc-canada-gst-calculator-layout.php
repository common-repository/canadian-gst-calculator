<?php
function load_cc_canada_gst_calc($id, $title, $bg_color, $border_color, $text_color, $show_url = 0)
{
    if ($show_url == 1)
...
<div class="CCG-Widget CCG-Widget-<?php echo $id; ?>">
	 	<div class="CCG-WidgetTitle CCG-WidgetTitle-<?php echo $id; ?>"><?php echo esc_attr($title); ?></div>		   
        ...
        <?php if ($show_url) { ?>
    		<div class="CCG-rowdiv" >
                <div class="CCG-WidgetSignature CCG-WidgetSignature-<?php echo $id; ?>">Provided by <a href="https://gstcalculator.ca" target="_blank">GSTcalculator.ca</a></div>
		    </div>
        <?php } ?>
