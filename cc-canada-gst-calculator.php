...
Plugin URI: https://gstcalculator.ca
Description: Canadian GST(Goods and Services Tax) Calculator
Version: 0.3.0
Author: Calculators Canada
Author URI: https://gstcalculator.ca/
License: GPL2

Copyright 2014-2024 GSTCalculator.ca (info@gstcalculator.ca)
...
class cc_canada_gst_calculator extends WP_Widget {
	...
	function widget($args, $instance) {
       ...
       //  print_r($args);
		...
		//	 $title = '<a href="https://gstcalculator.ca/" target="_blank" style="text-decoration:none">' . $title . '</a>';		
		load_cc_canada_gst_calc($this->id, $title, $bg_color, $border_color, $text_color, $allow_cc_urls);
...
function cc_canada_gst_calculator_init ()
{
    return register_widget('cc_canada_gst_calculator');
}
add_action ('widgets_init', 'cc_canada_gst_calculator_init');
...
function cc_gst_scripts() {
    ...
    wp_enqueue_script( 'cc-canada-gst-calculator', plugins_url('/cc-canada-gst-calculator.js',__FILE__), array('jquery'), '0.3.0', true );
}
